...
\begin{figure}[t!]
\centering
\includegraphics[width=1.2\columnwidth]{figures/schemes/receding_horizon_new_paper.pdf}
...
\addConstraint{\int\limits_{0}^{\sigma} \boldsymbol{\tau}_{ext}^T \command \ dt \geq -S(0) + \epsilon + \delta_t}{}{ \text{\ (Passivity)}}
