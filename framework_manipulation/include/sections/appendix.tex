...
\begin{tabular}{c | c c}
 \toprule
 \multirow{8}{4em}{Sampling-Based\\Controller} 
 & rollouts       & 40       \\
 & $\Delta t$     & 0.015s   \\
 & $T$            & 1s       \\     
 & $h$            & 10       \\
 ...
 & $\epsilon$ & $2J$ \\
 \midrule
 \multirow{5}{4em}{FILTER-QP \\Slack Penalties}
 ...
 \bottomrule
\end{tabular}
\caption{The table summarizes the most relevant method's parameters. Note that the same set of parameters have been used for all different objects in simulation and real world experiments.}
