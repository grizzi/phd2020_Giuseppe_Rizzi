...
\add{
\begin{enumerate}
    \item a new framework that combines sampling-based receding horizon control, control barrier and passivity methods for mobile manipulation control. A stability study provides theoretical guarantees on the overall control architecture;
