...
\title{
\remove{A Framework for Interaction Control of Mobile Manipulators}\add{Robust Sampling-Based Control of Mobile Manipulators for Interaction with Articulated Objects}
}


\author{Giuseppe Rizzi, Jen Jen Chung,~\IEEEmembership{Member,~IEEE}, Abel Gawel, Lionel Ott, Marco Tognon, and Roland Siegwart,~\IEEEmembership{Fellow,~IEEE}% <-this % stops a space
