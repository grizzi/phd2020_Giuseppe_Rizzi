...
\paragraph{Assumptions} While we would keep the approach as general as possible, we make a set of assumptions to ammeliorate the complexity of the problem:  
\begin{itemize}
